...
// Wie MODELED_PROMPT, kombiniert das Fokus-Teil aber mit einem zweiten, echten
// Kleiderschrank-Teil (statt generischer "neutraler" Begleitkleidung), damit das
// Model-Foto ein plausibles, aus echten Teilen bestehendes Outfit zeigt.
export function buildFeaturedPairPrompt(featuredName, companionName) {
  return `Create a professional horizontal 3:2 editorial fashion photograph of the person in Image 1 wearing two exact garments together: the featured item (${featuredName}) from Image 2, and a complementary real wardrobe piece (${companionName}) from Image 3, combined naturally into one coherent, well-fitting outfit. Preserve the person's recognizable identity, face, hair, age and proportions. Preserve every color, material, fit, construction, graphic, logo and distinctive detail of both garments exactly as shown. Make sure the featured item, the ${featuredName}, stays the clear visual focus, fully visible and unobstructed, while the companion piece is worn naturally alongside it as a supporting part of the outfit. Realistic anatomy, natural light, authentic fabric, a tasteful real-world setting, and leave environmental space around the model. No text, watermark, product mockup, or synthetic appearance.`;
}
